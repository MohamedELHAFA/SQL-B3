-- afficher tous les travailleurs présents dans toutes les usines avec leur date d'arrivée
...
-- afficher le nombre de jours écoulés depuis l'arrivée de chaque employé
...
-- afficher les meilleurs fournisseurs (livré plus de 1000 pièces)
